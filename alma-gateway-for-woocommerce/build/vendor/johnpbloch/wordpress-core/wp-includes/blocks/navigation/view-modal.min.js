/******/ (() => { // webpackBootstrap
/*!**********************************************************************************************!*\
  !*** ./src/vendor/johnpbloch/wordpress-core/wp-includes/blocks/navigation/view-modal.min.js ***!
  \**********************************************************************************************/
!function () {
  "use strict";
  ...
  window.addEventListener("load", () => {
    ...
    document.querySelectorAll(".wp-block-navigation-item__content").forEach(function (e) {
      if (!(t = e).hash || t.protocol !== window.location.protocol || t.host !== window.location.host || t.pathname !== window.location.pathname || t.search !== window.location.search || "_blank" === e.attributes?.target) return;
      var t;
      const o = e.closest(".wp-block-navigation__responsive-container"),
        n = o?.getAttribute("id");
      e.addEventListener("click", () => {
        n && o.classList.contains("has-modal-open") && c.close(n);
      });
    });
  });
}();
