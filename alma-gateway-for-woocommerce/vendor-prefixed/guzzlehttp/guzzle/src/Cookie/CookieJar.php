...
class CookieJar implements CookieJarInterface
{
    ...
    /**
     * @return \Alma_Gateway_ArrayIterator<int, SetCookie>
     */
    public function getIterator(): \Alma_Gateway_ArrayIterator
    {
        return new \Alma_Gateway_ArrayIterator(\array_values($this->cookies));
    }
