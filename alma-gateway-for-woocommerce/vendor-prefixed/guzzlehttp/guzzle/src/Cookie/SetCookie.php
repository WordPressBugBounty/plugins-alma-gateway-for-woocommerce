...
namespace Alma\Vendor\GuzzleHttp\Cookie;

use Alma\Vendor\GuzzleHttp\Handler\HostValidator;
...
class SetCookie
{
    ...
    {
        if (!is_string($name)) {
            alma_gateway_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a string to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setDomain($domain): void
    {
        if (!is_string($domain) && null !== $domain) {
            alma_gateway_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a string or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setMaxAge($maxAge): void
    {
        if (!is_int($maxAge) && null !== $maxAge) {
            alma_gateway_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing an int or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function setExpires($timestamp): void
    {
        if (!is_int($timestamp) && !is_string($timestamp) && null !== $timestamp) {
            alma_gateway_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing an int, string or null to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    {
        if (!is_bool($secure)) {
            alma_gateway_trigger_deprecation('guzzlehttp/guzzle', '7.4', 'Not passing a bool to %s::%s() is deprecated and will cause an error in 8.0.', __CLASS__, __FUNCTION__);
        }
    ...
    public function matchesDomain(string $domain): bool
    {
        ...
        if (\filter_var($domain, \Alma_Gateway_FILTER_VALIDATE_IP)) {
            return false;
        }
    ...
    private static function isIpAddressOrNumericHost(string $host): bool
    {
        ...
        if (\filter_var($host, \Alma_Gateway_FILTER_VALIDATE_IP) !== false) {
            return true;
        }
