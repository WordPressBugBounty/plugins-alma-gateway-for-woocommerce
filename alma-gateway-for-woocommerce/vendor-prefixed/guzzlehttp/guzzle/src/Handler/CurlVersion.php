...
final class CurlVersion
{
    ...
    public static function supportsHttp2(): bool
    {
        ...
        return self::supportsTls12()
            ...
            && $versionInfo !== null
            && 0 !== (\Alma_Gateway_CURL_VERSION_HTTP2 & $versionInfo['features']);
    }
    ...
    public static function supportsHttpsProxy(): bool
    {
        ...
        $httpsProxyFeature = \defined('CURL_VERSION_HTTPS_PROXY') ? \Alma_Gateway_CURL_VERSION_HTTPS_PROXY : (1 << 21);
    ...
    public static function supportsNtlm(): bool
    {
        ...
        $ntlmFeature = \defined('CURL_VERSION_NTLM') ? \Alma_Gateway_CURL_VERSION_NTLM : (1 << 4);
    ...
    private static function supportsSsl(): bool
    {
        ...
        return \defined('CURL_VERSION_SSL')
            && $versionInfo !== null
            && 0 !== (\Alma_Gateway_CURL_VERSION_SSL & $versionInfo['features']);
    }
