...
final class CurlShareHandleState
{
    ...
    /**
     * @param resource|\Alma_Gateway_CurlShareHandle|null $handle
     */
    ...
    public static function normalizeMode($share, string $option): string
    {
        ...
        throw new \InvalidArgumentException(\sprintf(
            'The "%s" option must be null, Alma\\Vendor\\GuzzleHttp\\Handler\\Alma_Gateway_CurlShare::NONE, or GuzzleHttp\\Handler\\Alma_Gateway_CurlShare::HANDLER; received %s.',
            $option,
    ...
    /**
     * @param resource|\Alma_Gateway_CurlShareHandle $handle
     */
