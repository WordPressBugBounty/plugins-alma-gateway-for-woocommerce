...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\Alma\Vendor\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\Stringable)
    ...
    /**
     * cookies: (false|Alma\Vendor\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\Alma\Vendor\Psr\Http\Message\StreamInterface) Where the data
