...
final class Middleware
{
     ...
     *
     * @param array|\Alma_Gateway_ArrayAccess<int, array> $container Container to hold the history (by reference).
     *
     * @return callable(callable): callable Returns a function that accepts the next handler.
     *
    ...
    {
        if (!\is_array($container) && !$container instanceof \Alma_Gateway_ArrayAccess) {
